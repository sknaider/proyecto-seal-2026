...
5. **Extensible at every layer.** Backend, embedding, and LLM are swappable interfaces. Bring your own Postgres, your own sentence transformer, your own inference server.
...
│   ├── postgres.py      #   PostgresBackend — for multi-agent / production
