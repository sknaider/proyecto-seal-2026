...
class AutoWireManager:
    ...
    def reconcile(self) -> dict[str, object]:
        ...
        for candidate in candidates:
            ...
            # Discovery proves protocol compatibility, never process identity.
            # Raw HTTP providers are brain-only: private memory is delivered
            # through the separately authenticated MCP attachment path.
            memory_allowed = False
            state = ProviderState.ACTIVE if active else ProviderState.DISCOVERED
