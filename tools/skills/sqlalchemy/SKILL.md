...
# With async support
python -m pip install sqlalchemy[asyncio] aiosqlite  # SQLite
python -m pip install sqlalchemy[asyncio] asyncpg    # PostgreSQL

# With Alembic for migrations
python -m pip install alembic

# FastAPI integration
python -m pip install fastapi sqlalchemy
```
