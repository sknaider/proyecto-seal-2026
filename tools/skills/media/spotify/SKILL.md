...
Control the user's Spotify account via the SEAL Spotify toolset (7 tools). Setup guide: https://soul.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `soul auth spotify` again.
