...
```python
import sys
sys.path.insert(0, "/home/teknium/.soul/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.soul/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — SEAL installs package this)
