...
version: 1.1.1
author: xdevplatform + openclaw + SEAL
license: MIT
...
# Inspect and verify the release checksum before executing downloaded code.
...
- SEAL adaptation: reformatted for SEAL skill conventions; safety guardrails preserved verbatim.
