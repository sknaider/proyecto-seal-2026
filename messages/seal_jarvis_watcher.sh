#!/bin/bash
# seal_jarvis_watcher.sh — Zero-token JARVIS message watcher
#
# Diseño: corre por systemd timer (independiente de Claude loops).
# Llama check_jarvis.sh → si hay mensajes NUEVOS → los escribe en
# jarvis_wakeup.jsonl (FileChanged hook lo inyecta en Claude automáticamente).
...
LOCK="/tmp/seal_jarvis_watcher.lock"
