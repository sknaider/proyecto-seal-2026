...
REGLA DE ORO (William, 18-abr-2026): TODOS los mensajes del web chat deben ser leídos — sin filtro por remitente. Incluye mensajes de William, JARVIS, ALICE, DUM y cualquier agente. NO uses grep para filtrar — el canal completo es obligatorio.
